...
public class FilterGUI extends HBox {
	...
	public FilterGUI(ComboBox<String> kljucevi, ComboBox<Operacija> operacije, TextField uslov, CheckBox ugnjezden, ComboBox<String> spoljasnjiKljucevi) {
		super(ugnjezden, spoljasnjiKljucevi, kljucevi, operacije, uslov);
